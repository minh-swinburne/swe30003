...
{
    public static TQuery CreateQuery<TQuery>(BaseDTO requestDTO) where TQuery : IQuery, new()
    {
    ...
    public static TCommand CreateCommand<TCommand>(BaseDTO requestDTO) where TCommand : ICommand, new()
    {
